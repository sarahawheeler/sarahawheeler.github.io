...
<vegachart schema-url="{{ site.baseurl }}/assets/json/population.json" style="width: 100%"></vegachart>
...
<vegachart schema-url="{{ site.baseurl }}/assets/json/population_density.json" style="width: 100%"></vegachart>
